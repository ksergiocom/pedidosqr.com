...
const EditPage = ({ articulos, mesa, pedido }) => {
    const [cantidades, setCantidades] = useState(() => {
        const inicial = {};

        // Inicializar con cantidades actuales del pedido
        ...
        <main className="p-5 w-xl mx-auto">
            ...
            <div className="mt-8 flex justify-between items-center">
                <p className="text-lg text-gray-500 font-thin">
                    Total artículos: <strong className='text-black font-bold'>{cantidadTotal}</strong>
                </p>
                <p className="text-lg text-gray-500 font-thin">
                    Importe total: <strong className='text-black font-bold'>{importeTotal.toFixed(2)}€</strong>
                </p>
            </div>

            <Button className='w-full mt-10' onClick={actualizarPedido}>
                Actualizar pedido
            </Button>
        </main>
    );
